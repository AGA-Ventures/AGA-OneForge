...
description: How AGA OneForge decides whether each part is made, bought, or pulled from stock, and how a job gets its own copy of the recipe.
---
...
These are two different questions, and AGA OneForge keeps them separate:
...
When you create a job, AGA OneForge runs **Get Method**. It copies the part's method into a job-specific copy.
