---
title: Shelf life
description: How AGA OneForge stamps expiration dates on tracked stock, and blocks consuming it once expired.
---

**Shelf life** is how AGA OneForge decides when a batch or serial of an item *expires*, and what happens when
...
Say a batch of adhesive is received under a **180-day** policy: AGA OneForge stamps that lot to expire about six
...
<Callout type="note">
The expiration date is only ever written once, where it was blank. AGA OneForge never silently overwrites a date a
