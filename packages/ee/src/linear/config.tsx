...
export const Linear = defineIntegration({
  ...
  logo: Logo,
  description:
    "Linear is a project management software that allows you to create issues and track project progress seamlessly. With this integration, you can link issues from AGA OneForge to Linear.",
  shortDescription: "Sync issues from AGA OneForge to Linear.",
  ...
  return (
    <>
      <p className="text-sm text-muted-foreground">
        To integrate Linear with AGA OneForge, start by logging into your Linear
