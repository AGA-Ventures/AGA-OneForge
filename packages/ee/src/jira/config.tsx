...
export const Jira = defineIntegration({
  ...
  logo: Logo,
  description:
    "Jira is a project management and issue tracking tool by Atlassian. With this integration, you can link quality issues from AGA OneForge to Jira for tracking and collaboration.",
  shortDescription: "Sync quality issues from AGA OneForge to Jira.",
  ...
  return (
    <>
      <p className="text-sm text-muted-foreground">
        To integrate Jira with AGA OneForge, click the "Connect" button above to
        authorize AGA OneForge with your Atlassian account.
      </p>
      <p className="text-sm text-muted-foreground">
