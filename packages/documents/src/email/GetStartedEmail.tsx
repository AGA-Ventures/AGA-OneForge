...
export const GetStartedEmail = ({
  ...
  const preview = `Hi ${firstName}, here's how to get the most out of AGA OneForge.`;
  ...
  const resources: ResourceProps[] = [
    ...
    },
    {
      ...
      description: "Configure AGA OneForge for your team in minutes."
    },
    {
    ...
    },
    {
      ...
      title: "Using the API",
      description: "Build custom apps on top of AGA OneForge."
    }
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Get the most out of AGA OneForge
          </Heading>
